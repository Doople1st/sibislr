...
best_checkpoint = ModelCheckpoint('sibi_rgb_normal_9_15_weights_best.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='max')
checkpoint = ModelCheckpoint('sibi_rgb_normal_9_15_weights_epoch.hdf5', monitor='val_acc', verbose=1, save_best_only=False, mode='max')
csv_logger = CSVLogger('sibi_rgb_normal_9_15.log', append=False)
tensorboard = TensorBoard(log_dir='./sibi_rgb_normal_9_15_tf-logs')
